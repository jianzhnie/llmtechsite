// 侧边栏配置 — 板块有子分组的直接展开，无需外层冗余标题
const sidebar = {
  '/aigc/': [
    { text: '概述', link: '/aigc/' },
    { text: 'ChatGPT', collapsed: true, items: [
    ...
    { text: 'LLM Pretrain', collapsed: true, items: [
    ...
    { text: 'LLM Agent', collapsed: true, items: [
  ...
  '/rlhf/': [
    { text: '概述', link: '/rlhf/' },
    { text: 'LLM RLHF Framework', collapsed: true, items: [
      ...
      { text: '参数转换指南', link: '/rlhf/infra/OpenRLHF&Verl参数转换指南' },
      { text: 'Ray 角度分析', link: '/rlhf/infra/Ray_OpenRLHF_Verl' },
      { text: 'Ray与RL框架设计', link: '/rlhf/infra/Ray与LLM强化学习框架设计' },
    ]},
    { text: 'Verl 源码分析', collapsed: true, items: [
    ...
    { text: 'LLM RLHF Intro', collapsed: true, items: [
      { text: '理解 RLHF', link: '/rlhf/intro/rlhf_advance' },
      { text: 'Chip Huyen 分析', link: '/rlhf/intro/rlhf_chiphuyen' },
    ...
    { text: 'RLHF Algorithm and Paper', collapsed: true, items: [
  ...
  '/inference/': [
    ...
    { text: 'LLM Inference', collapsed: true, items: [
    ...
    { text: 'vLLM', collapsed: true, items: [
  ...
  '/ultrascale/': [
    ...
    { text: 'DeepSpeed', collapsed: true, items: [
    ...
    { text: 'PyTorch 分布式', collapsed: true, items: [
    ...
    { text: 'MMEngine', collapsed: true, items: [
  ...
  '/ascend/': [
    ...
    { text: 'MindSpeed 特性', collapsed: true, items: [
  ...
  '/architecture/': [
    { text: '模型架构', collapsed: false, items: [
  ...
  '/diffusion/': [
    { text: '扩散模型', collapsed: false, items: [
  ...
  '/multimodal/': [
    { text: '多模态', collapsed: false, items: [
  ...
  '/rlwiki/': [
    { text: '概述', link: '/rlwiki/' },
    { text: '入门教程', collapsed: true, items: [
    ...
    { text: 'AlphaZero & MuZero', collapsed: true, items: [
    ...
    { text: '多智能体 RL', collapsed: true, items: [
    ...
    { text: 'RL 环境', collapsed: true, items: [
  ...
  '/toolbox/': [
    { text: '效率工具', collapsed: false, items: [
      ...
      { text: 'CS 技术栈', link: '/toolbox/study/cs_techself' },
      { text: 'AutoCut', link: '/toolbox/study/autocut' },
  ...
  '/dlwiki/': [
    { text: '概述', link: '/dlwiki/' },
    { text: '分布式训练', collapsed: true, items: [
    ...
    { text: 'Vision Transformer', collapsed: true, items: [
  ...
  '/mlwiki/': [
    { text: '概述', link: '/mlwiki/' },
    { text: 'AutoML 工具箱', collapsed: true, items: [
    ...
    { text: 'Python Handbook', collapsed: true, items: [
