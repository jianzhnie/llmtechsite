          ...
          items: [
            { text: '概述', link: '/aigc/' },
            {
              ...
              items: [
                ...
                { text: '聊天模板指南', link: '/aigc/chatgpt/chat_template' },
              ]
            },
            {
              text: 'LLM Pretrain',
              ...
              items: [
                ...
                { text: '旋转位置编码', link: '/aigc/llm_pretrain/rope' },
              ]
            },
            {
              text: 'LLM Finetune',
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'LLM StarCraftII 1', link: '/aigc/llm_agent/llm_starcraft_1' },
                { text: 'LLM StarCraftII 2', link: '/aigc/llm_agent/llm_starcraft_2' },
                { text: 'LLM StarCraftII 3', link: '/aigc/llm_agent/llm_starcraft_3' },
              ]
            },
            {
              text: 'LLM Evaluation',
          ...
          items: [
            { text: '概述', link: '/rlhf/' },
            {
              ...
              items: [
                ...
                { text: 'ARealLite', link: '/rlhf/infra/ARealLite' },
                ...
                { text: 'Ray与LLM RL框架设计', link: '/rlhf/infra/Ray与LLM强化学习框架设计' },
              ]
            },
            {
              text: 'Verl 源码分析',
              collapsed: true,
              items: [
                { text: '核心算法实现', link: '/rlhf/infra/verl/core_algos' },
                { text: '单控制器设计', link: '/rlhf/infra/verl/verl.single_controller设计详解' },
                { text: 'Hybrid Flow', link: '/rlhf/infra/verl/verl_design' },
                { text: 'PPO 架构详解', link: '/rlhf/infra/verl/verl_ppo' },
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Chip Huyen: RLHF分析', link: '/rlhf/intro/rlhf_chiphuyen' },
                { text: 'RLHF 知识整理', link: '/rlhf/intro/rlhf_overview' },
                { text: 'KL 散度近似计算', link: '/rlhf/intro/KL散度的近似计算方法' },
                { text: 'Policy Gradient', link: '/rlhf/intro/rlhf_policy_gradient' },
                { text: 'GRPO 系列改进', link: '/rlhf/intro/grpo-to-dapo-and-gspo' },
                { text: '重新思考 PPO-Clip', link: '/rlhf/intro/ppo_clip' },
                { text: '截断重要性采样', link: '/rlhf/intro/truncated_importance_sampling' },
                { text: '动态微调', link: '/rlhf/intro/Dynamic-Fine-Tuning' },
              ]
            },
            {
              text: 'RLHF Algorithm and Paper',
              collapsed: true,
              items: [
                ...
                { text: 'ChatGPT O1', link: '/rlhf/paper/chatgpt_O1' },
                { text: '过程奖励模型', link: '/rlhf/paper/PRM' },
          ...
          items: [
            { text: '概述', link: '/inference/' },
            {
              ...
              items: [
                ...
                { text: 'KVCaching 机制', link: '/inference/KVCaching机制详解' },
                ...
                { text: 'Chat Template', link: '/inference/ChatTemplate' },
                { text: '推理指标', link: '/inference/llm-inference-metrics' },
                { text: 'Flash Attention', link: '/inference/flashattention' },
                { text: 'KV Cache Offloading', link: '/inference/KVCacheOffloading' },
              ]
            },
            {
              text: 'vLLM',
              ...
              items: [
                ...
                { text: 'vLLM Graph Mode', link: '/inference/vllm/vllm_graph_mode' },
              ]
            },
            {
              text: 'SGLang',
      ...
      '/ultrascale/': [
        {
          ...
          items: [
            ...
            { text: '训练技术概论', link: '/ultrascale/Ultra-scale-llm-training-tech' },
            { text: 'Ray 核心概念', link: '/ultrascale/Ray核心概念' },
            {
              ...
              items: [
                ...
                { text: 'ZeRO 原理 (上)', link: '/ultrascale/deepspeed/zero-optimizer-1' },
                { text: 'ZeRO 原理 (下)', link: '/ultrascale/deepspeed/zero-optimizer-2' },
              ]
            },
            {
              text: 'PyTorch 分布式',
              collapsed: true,
              items: [
                { text: '分布式教程', link: '/ultrascale/torch/torch_distributed' },
                { text: 'FSDP 介绍', link: '/ultrascale/torch/torch_fsdp' },
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'MMEngine 概述', link: '/ultrascale/mmengine/engine' },
      ...
      '/ascend/': [
        {
          ...
          items: [
            ...
            { text: '脑海2B模型强化微调', link: '/ascend/脑海2B模型强化微调' },
            { text: 'WandB Tables 记录文本', link: '/ascend/使用WandBTables记录生成的文本数据' },
            {
              text: 'MindSpeed 特性',
              collapsed: true,
              items: [
                { text: 'DualPipeV', link: '/ascend/mindspeed/features/dualpipev' },
                { text: 'Tensor Parallel 2D', link: '/ascend/mindspeed/features/tensor-parallel-2d' },
                { text: 'Fused EMA AdamW', link: '/ascend/mindspeed/features/fused_ema_adamw_optimizer' },
                { text: 'Conv3D Sequence Parallel', link: '/ascend/mindspeed/features/conv3d_sequence_paralle' },
                { text: 'Pipeline Parallel', link: '/ascend/mindspeed/features/pipeline-parallel' },
                { text: 'Tensor Parallel', link: '/ascend/mindspeed/features/tensor-parallel' },
                { text: 'Sequence Parallel', link: '/ascend/mindspeed/features/sequence-parallel' },
                { text: 'Ulysses Context Parallel', link: '/ascend/mindspeed/features/ulysses-context-parallel' },
                { text: 'Ring Attention CP', link: '/ascend/mindspeed/features/ring-attention-context-parallel' },
                { text: 'Recomputation', link: '/ascend/mindspeed/features/recomputation' },
                { text: 'Virtual Pipeline', link: '/ascend/mindspeed/features/virtual-pipeline-parallel' },
                { text: 'Auto Settings', link: '/ascend/mindspeed/features/auto_settings' },
                { text: 'MC2', link: '/ascend/mindspeed/features/mc2' },
              ]
            },
            { text: 'NPU Flash Attention', link: '/ascend/NPUFlashAttentionScore' },
            { text: 'Data Packing', link: '/ascend/DataPacking' },
            { text: '长上下文长度', link: '/ascend/long_context_length' },
            { text: 'LLM中MFU的计算', link: '/ascend/LLM中MFU的计算' },
            { text: 'RLTricks 总结', link: '/ascend/RLTricks总结' },
          ]
        }
      ],
      ...
      '/diffusion/': [
        {
          ...
          items: [
            ...
            { text: '数学原理', link: '/diffusion/math101' },
      ...
      '/rlwiki/': [
        {
          ...
          items: [
            { text: '概述', link: '/rlwiki/' },
            {
              text: '入门教程 (HuggingFace RL)',
              collapsed: true,
              items: [
                { text: '一: 深度强化学习简介', link: '/rlwiki/hfrlclass/ch1_introduction' },
                { text: '二: Q-Learning', link: '/rlwiki/hfrlclass/ch2_q-learning' },
                { text: '三: Deep Q-Learning', link: '/rlwiki/hfrlclass/ch3_dqn' },
                { text: '四: Policy Gradient', link: '/rlwiki/hfrlclass/ch4_pg' },
                { text: '五: Actor-Critic', link: '/rlwiki/hfrlclass/ch5_a2c' },
                { text: '六: PPO', link: '/rlwiki/hfrlclass/ch6_ppo' },
                { text: '七: Decision Transformer', link: '/rlwiki/hfrlclass/ch7_decision-transformer' },
                { text: '八: Multi-Agent RL', link: '/rlwiki/hfrlclass/ch8_marl' },
                { text: '九: RL 前沿主题', link: '/rlwiki/hfrlclass/ch9_advanced' },
              ]
            },
            {
              text: '进阶教程',
              ...
              items: [
                ...
                { text: 'A2C Baseline 方差', link: '/rlwiki/algorithms/ch1_supp_a2c' },
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'PER', link: '/rlwiki/papers/PER' },
      ...
      '/toolbox/': [
        {
          ...
          items: [
            ...
            { text: 'Kindle 电子书', link: '/toolbox/study/kindle' },
          ]
        }
      ],
      ...
      '/dlwiki/': [
        {
          ...
          items: [
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'ViT 概述', link: '/dlwiki/transformers/' },
      ...
      '/mlwiki/': [
        {
          ...
          items: [
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'Spark 概述', link: '/mlwiki/Spark/Spark' },
                { text: 'Spark RDD', link: '/mlwiki/Spark/Spark_RDD' },
                { text: 'SparkSQL', link: '/mlwiki/Spark/SparkSQL' },
                { text: 'Scala 编程', link: '/mlwiki/Spark/Scala编程' },
                { text: 'Scala Style Guide', link: '/mlwiki/Spark/scala-style-guide' },
              ]
            },
            {
