# 比 LLM 更重要的多模态学习（MultiModal Learning）

## 多模态学习相关概念介绍

模态（modal）是事情经历和发生的方式。我们生活在一个由多种模态（Multimodal）信息构成的世界，包括视觉信息、听觉信息、文本信息、嗅觉信息等。在日常生活中，我们经常接触不同模态的数据，例如文字、语音、图片。这些都是明显的不同模态的数据。如果进一步拓宽视野，会发现模态可以理解为一种表达、记录或感知事物的方式。每种不同的存储方式都可以被认为是一种不同的模态。

有的模态更接近传感器的原始数据，如语音、图像；有的模态则涉及更抽象的概念，如情绪、物体分类。过去我们更倾向于处理单一模态数据，如仅处理文字或图片。但现在，随着技术发展，我们不仅需要处理更多的模态，还需要处理模态之间的关联。多模态学习，就是要从这些具有异构性但又相互关联的数据中去学习和理解信息。

当研究问题或数据集包含多种模态信息时，我们称之为多模态问题。研究多模态问题是推动人工智能更好地了解和认知周围世界的关键。
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F093fa1f2-a2b3-4d3f-8719-62218cbb6eb3%2FUntitled.png?table=block&id=e7c6bdfc-2cd6-4533-8eb2-4f50d9aa8773" alt="notion image" style="zoom:33%;" />
...
大约在 2017 年，这种模态之间的耦合度开始发生显著变化。这主要归功于 Transformer 模型的出现，它是一个跨模态应用的强大框架。由于 Transformer 模型的出现，各种不同行业或模态的数据开始向通用单一框架靠拢。
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Ff3d136bd-1929-4a81-9772-5e0a00bdcb4e%2FUntitled.png?table=block&id=90e853c3-74d7-4c4b-abd1-ef19c02f9ef3" alt="notion image" style="zoom:33%;" />
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F8cdc4f77-505a-494c-a42a-418e9dc7f1c2%2FUntitled.png?table=block&id=5efd1821-8000-4ba2-abe6-26e6e3d2d0c3" alt="notion image" style="zoom:33%;" />
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F7006e5b9-482a-4807-a7d8-431acc63999f%2FUntitled.png?table=block&id=dd63047b-e25d-4096-a6e8-ceb893b65147" alt="notion image" style="zoom:33%;" />
...
<img src="https://oss.imzhanghao.com/img/202211051339734.png" alt="多模态学习的技术挑战" style="zoom:33%;" />
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Ff3fd73f2-632e-4eac-8104-a7637f5a83f1%2FUntitled.png?table=block&id=9254c20c-3af8-4fd4-a2c6-8f70ad8fef17" alt="notion image" style="zoom:33%;" />
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fcc75f75e-6aac-42d9-9a12-de18a0ae2ca2%2FUntitled.png?table=block&id=17fbb9f5-7086-4d07-8119-67994a47d0dc" alt="notion image" style="zoom:33%;" />

### CLIP

CLIP 模型的思路非常简单，它将图片和文本利用Transformer分别编码为向量，然后使用**对比学习（ITC）**的方式进行训练。ITC使来自同一对的图片和文本的向量在向量空间中尽可能地靠近，而来自不同对的图片和文本的向量在向量空间中尽可能地远离。
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F84148371-5c78-4040-ab36-3e9311b9a5ee%2FUntitled.png?table=block&id=1df84fc7-4eb0-4f2d-8106-a113cd501ebc" alt="notion image" style="zoom: 50%;" />



<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F5c3301b5-97f9-45ed-936a-636dd1dd9d5c%2FUntitled.png?table=block&id=b145d9c5-e587-4c21-9fdb-c769740aef10" alt="notion image" style="zoom:33%;" />
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F1d49697b-fd0c-4b12-804d-315609aac447%2FUntitled.png?table=block&id=f4b80aec-e0e8-49a4-9a07-6b6b793d557c" alt="notion image" style="zoom:33%;" />
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F36bb7df0-c87c-4261-bc5e-6a1c0c451708%2FUntitled.png?table=block&id=4bf5caaf-c5e3-4dd0-b58e-4fcc69370751" alt="notion image" style="zoom:33%;" />

数据对齐还可以分为**粗粒度对齐**和**细粒度对齐**。细粒度对齐数据是非常困难的。例如，将一个名词准确地对齐到图片中的特定部分，或者将动词与具体的动作对齐，这都是非常复杂且困难的任务。此外，如果需要对齐的数据具有层级关系，那么这个任务就更加困难了。
...
<img src="https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fbd8e9951-0a2d-4545-87a4-042f24535486%2FUntitled.png?table=block&id=6e01d435-be37-4b1c-a7ef-a3958dc2c576" alt="notion image" style="zoom:33%;" />
...
- [Multimodal Learning--much more important than LLM.pdf](https://file.notion.so/f/s/5e1f507e-b484-4903-86dd-bfec2c60968d/Multimodal_Learning--much_more_important_than_LLM.pdf?id=48cd395e-0cca-4bc4-9f02-9ca655cca25d&table=block&spaceId=9341931a-53f0-48e1-b026-0f1ad17b457c&expirationTimestamp=1699675200000&signature=qQJuLVlUX072faAIDv7AxePNCVzinDq-ZllEfMkR2JA)
- https://imzhanghao.com/2022/10/27/multimodal-learning/
- [CLIP: Connecting Text and Images / openai / blog](https://openai.com/blog/clip/)
