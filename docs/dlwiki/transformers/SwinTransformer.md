...
<!-- <!-- broken image: SwinTransformer.assets/v2-f9c4e3d69da7508562358f9c3f683c63_b.png -->
...
<!-- <!-- broken image: SwinTransformer.assets/v2-c7140d26adf8a4c9d8b2609488ce71ee_b.jpg -->
...
<!-- <!-- broken image: SwinTransformer.assets/v2-5b1f589ca71a4bc406a266296025b4b4_b.jpg -->
...
<!-- <!-- broken image: SwinTransformer.assets/v2-0c99206fb39da67bae3415a650c38742_b.png -->
...
<!-- <!-- broken image: SwinTransformer.assets/v2-07a98325a29db1da6521e4ddaaed3c88_b.jpg -->
...
<!-- <!-- broken image: SwinTransformer.assets/v2-84b7dd5ba83bf0c686a133dec758d974_b.jpg -->

## **特征图移位操作**

代码里对特征图移位是通过`torch.roll`来实现的，下面是示意图

<!-- <!-- broken image: SwinTransformer.assets/v2-7b594ca54a3cfac5370d8fef2be6f768_b.jpg -->
...
<!-- <!-- broken image: SwinTransformer.assets/v2-d80364e0b73c60bcd8a60bbd91cfbaeb_b.jpg -->

 我们希望在计算Attention的时候，**让具有相同index QK进行计算，而忽略不同index QK计算结果**。

最后正确的结果如下图所示

<!-- <!-- broken image: SwinTransformer.assets/v2-e72bf67b5cbcc27e2d2640bcd3522d0e_b.jpg -->
...
<!-- <!-- broken image: SwinTransformer.assets/v2-b1f64ea254af2c7b1cdbaf9288731371_b.jpg -->
...
<!-- <!-- broken image: SwinTransformer.assets/v2-bf00e048de979decd68ebc7c5372cb27_b.jpg -->
